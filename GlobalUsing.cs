...
namespace RewindSubtitleDisplayerForPlex
{
    ...
    public static class MyStrings
    {
        ...
        public const string RememberTVShowSubtitleListFile = "Remember_TVShow_Subtitles_List.txt";
        ...
        public const string RememberShowHeaderLines = "# Remembered Enabled Subtitles TV Shows List\n" +
            "# This file is automatically generated and managed by the application.\n" +
            "# You can edit this manually but the names need to be exact. It's easier to just enable the subtitles while watching the show, it will detect it.\n";
